  ...
  return (
    <div className="max-w-4xl mx-auto py-32 animate-fadeIn text-center space-y-12 px-6">
      <div className="space-y-6">
        ...
        <h2 className="text-6xl md:text-8xl font-black text-brand-dark tracking-tighter uppercase italic leading-none">Feedback 360</h2>
        <p className="text-brand-muted text-xl md:text-2xl font-medium max-w-2xl mx-auto">
          דוח ה-360 המלא מנוהל במערכת הייעודית של גלעד קילון.
        </p>
      </div>
      ...
      <div className="studio-card p-12 md:p-20 border-brand-dark bg-white shadow-[12px_12px_0px_#1a1a1a] space-y-10">
        ...
        <div className="space-y-4">
           <p className="text-2xl text-brand-dark font-bold leading-relaxed">סינתזת משוב מנהל</p>
           <p className="text-brand-muted font-medium italic">הקש על הכפתור למטה כדי לעבור למערכת המשוב החיצונית.</p>
        </div>
        <div className="pt-6">
          <a 
